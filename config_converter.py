...
class ConfigConverter:
    ...
    def setup_training_args(self, init_config):
        ...
        if 'resume_from_checkpoint' in init_config and init_config['resume_from_checkpoint']:
            self.ex_config['resume_from_checkpoint'] = init_config['resume_from_checkpoint']
